...
//  PlayerMusic
//
//  Created by Mattia Marranzino on 23/11/23.
//
            ...
            ZStack{
                ...
                VStack{
                    ...
                    HStack{
                       ...
                       .accentColor(.white)
                       .accessibilityValue("\(timeString(time:currentTime))")
                                    ...
                                    VStack{
                                        ...
                                        HStack{
                                            VStack{
                                                ...
                                                }.padding().disabled(!toggleBool).accessibilityLabel("Metronomo Volume slider, is disable if metronomo is off")
                                            }.padding()
                                            VStack{
                                                Text("L & R")
                                                Slider(value: $rlPositionAudio,in: -1...1){ editing in
                                                    playerMetronome?.pan = rlPositionAudio
                                                }.padding().disabled(!toggleBool).accessibilityLabel("L & R slider, is disable if metronomo is off")
                                        ...
                                        Text("\(String(format: "%.1f", finalBpm))")
                                        Slider(value: $finalBpm, in: 23...190) { editing in
                                            player?.rate = finalBpm/songBpm
                                            playerMetronome?.rate = finalBpm/songBpm
                                            
                                            
                                        }.padding().accessibilityLabel("Bpm Song modify slider").accessibilityValue(String(format: "%.1f", finalBpm))
